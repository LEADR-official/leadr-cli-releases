...
REPO="LEADR-official/leadr-cli-releases"
...
case "$OS" in
  Darwin)
    ...
    ;;
  Linux)
    echo "Linux is not yet supported by this installer."
  ...
  MINGW*|MSYS*|CYGWIN*)
    ...
    echo "Please download leadr-*-windows-x86_64.exe from:"
    echo "https://github.com/$REPO/releases"
    exit 1
    ;;
  *)
...
echo "Run 'leadr --help' to get started"
